...
export default function PreviewEditorContentModal() {
    ...
    return (
        <>
            <Button size="sm"  className="mr-2 bg-white border-2" endContent={<EyeOutlined />}  onPress={onOpen}>Preview Editor</Button>
            <Modal size="5xl" isOpen={isOpen} onOpenChange={onOpenChange} isDismissable={false} isKeyboardDismissDisabled={true}>
                <ModalContent>
                    {(onClose) => (
                        <>
                            <ModalHeader className="flex flex-col gap-1">Preview Editor Content</ModalHeader>
                            <ModalBody>
